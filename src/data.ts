...
const allMobileProjects: MobileProject[] = [
    blinkArkUI, bmusic, bweather, harmonyCalculator
]

const allWebProjects: WebProject[] = [
    blink, connect
]
...
const getProject = async(id: string) => {
    let project = allMobileProjects.find((init)=> init.id === id);
    if(project){
        return project
    }
    return allWebProjects.find((init)=> init.id === id);
}

export { allMobileProjects, allWebProjects, randomMobileProjects, randomWebProjects, getProject }